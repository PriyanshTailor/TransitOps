...
const IconRoute = () => <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="6" cy="19" r="3"></circle><path d="M9 19h8.5a3.5 3.5 0 0 0 0-7h-11a3.5 3.5 0 0 1 0-7H15"></path><circle cx="18" cy="5" r="3"></circle></svg>;
...
const navItems = [
  { path: '/dashboard', label: 'Dashboard', icon: <IconDashboard />, allowedRoles: ['Super Admin', 'Fleet Manager', 'Safety Officer', 'Financial Analyst', 'Driver', 'Dispatcher'] },
  { path: '/telemetry', label: 'Live Telemetry', icon: <IconRoute />, allowedRoles: ['Driver'] },
  { path: '/vehicles', label: 'Vehicle Registry', icon: <IconCar />, allowedRoles: ['Super Admin', 'Fleet Manager', 'Dispatcher'] },
  { path: '/drivers', label: 'Driver Management', icon: <IconUsers />, allowedRoles: ['Super Admin', 'Safety Officer', 'Dispatcher'] },
  { path: '/trips', label: 'Trip Management', icon: <IconRoute />, allowedRoles: ['Super Admin', 'Driver', 'Dispatcher'] },
  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-footer">
        {(!userRole || ['Super Admin'].includes(userRole)) && (
